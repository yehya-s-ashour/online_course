...
class _editTextFieldsListState extends State<editTextFieldsList> {
  ...
  Widget build(BuildContext context) {
    description.text = widget.lessonModel.description;
    title.text = widget.lessonModel.name;
              ...
              ElevatedButton(
                  ...
                  onPressed: () {
                    TeacherCubit.get(context)
                      ...
                      image: widget.lessonModel.image,
                      subCategory: teacherCourseslist[widget.index].subCategory,
                      mainCategory: teacherCourseslist[widget.index].mainCategory,
