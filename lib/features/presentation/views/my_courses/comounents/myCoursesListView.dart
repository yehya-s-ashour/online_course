            ...
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                return myCoursesCourseCard(
                  course: LayoutCubit.get(context).currentindexEnrolled == 0
                      ? LayoutCubit.get(context).onGoginEnrollModel[index]
                      : LayoutCubit.get(context).completedEnrollModel[index],
                );
              },
              itemCount: LayoutCubit.get(context).currentindexEnrolled == 0
                  ? LayoutCubit.get(context).onGoginEnrollModel.length
                  : LayoutCubit.get(context).completedEnrollModel.length,
            ),
          ),
        ],
      ),
