...
class ImageWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Builder(builder: (context) {
      ...
      return InkWell(
        onTap: (){
          Get.to(ShowFullScreenImage(name: isMe ? 'You' :  message!.senderName,image: text,timeSent:  getTime(message!.timeSent).millisecondsSinceEpoch),transition: transition[2]);
        },
        child: Padding(
